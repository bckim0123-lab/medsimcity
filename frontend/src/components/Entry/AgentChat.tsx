...
function getMockReply(text: string): { text: string; json?: string } {
  ...
  if (
    ...
    (t.includes('\uC2DC\uBBEC\uB808\uC774\uC158') && (t.includes('\uC9C8\uD658') || t.includes('\uC815\uCC45')))
  ) {
  ...
  // 소아과/야간 시나리오 (기존)
  if (t.includes('\uC18C\uC544\uACFC') || t.includes('\uC57C\uAC04') || t.includes('\uCD94\uAC00') || t.includes('\uC2DC\uBBEC\uB808')) {
    return {
      text: '\uD655\uC778\uD558\uACA0\uC2B5\uB2C8\uB2E4. \uC815\uCC45 \uC2DC\uBBEC\uB808\uC774\uC158 \uC2DC\uC791 \uC804 \uD30C\uB77C\uBBF8\uD130\uB97C \uBD84\uC11D\uD569\uB2C8\uB2E4.\n\uD574\uB2F9 \uC9C0\uC5ED\uC758 \uC778\uAD6C \uBD84\uD3EC, \uD604\uC7AC \uC758\uB8CC \uC778\uD504\uB77C, \uC751\uAE09 \uC218\uC694\uB97C \uB85C\uB4DC\uD558\uACE0 \uC2DC\uBBEC\uB808\uC774\uC158\uC744 \uC218\uD589\uD569\uB2C8\uB2E4.',
      json: JSON.stringify({
        service: 'POLICY_SIMCITY',
        action: 'RUN_SIMULATION',
        params: {
...
const INIT_MSG: Message = {
  role: 'agent',
  text: '\uC548\uB155\uD558\uC138\uC694. MediSim \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uC5D0\uC774\uC804\uD2B8\uC785\uB2C8\uB2E4.\n\nHIRA, NHIS, KOSIS \uB370\uC774\uD130\uB97C \uC5F0\uB3D9\uD558\uC5EC \uC758\uB8CC \uACF5\uBC31 \uBD84\uC11D, \uC815\uCC45 \uC2DC\uBBEC\uB808\uC774\uC158, \uC218\uAC00 \uBD84\uC11D\uC744 \uC218\uD589\uD558\uB294 \uC5D0\uC774\uC804\uD2B8\uC785\uB2C8\uB2E4.\n\uC790\uC5F0\uC5B4\uB85C \uC9C8\uBB38\uD558\uC138\uC694.',
};
      ...
      <div className="bg-slate-900/60 border border-slate-700/60 rounded-2xl overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-4 pb-4">
          ...
          <p className="text-[10px] text-slate-700 mt-2 text-center">
            HIRA · NHIS · KOSIS {'\uB370\uC774\uD130 \uAE30\uBC18 \uC2DC\uBBEC\uB808\uC774\uC158 \uD5C8\uBE0C \uC5D0\uC774\uC804\uD2B8 \u2014 \uBB34\uB8CC \uB370\uBAA8 \uBC84\uC804'}
          </p>
        </div>
      </div>
    </div>
